...
namespace Game.Visuals
{
    ...
    ///     the body is a skinned/animated model (<see cref="CowboyVisual" />) without the controller knowing which
    ///     specific model. Implementations own the HOW of idle/move/hit/death; the controller only signals lifecycle
    ///     + the hit/death events + mechanical pause.
    /// </summary>
